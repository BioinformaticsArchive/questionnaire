...
namespace BHS_questionnaire_demo
{
    class QuestionTextTriple : Question
    {
        ...
        public override string processUserData()
        {
            ...
            if (validationCodeLabel == "Check3NumericReadings")
            {
            ...
            else if (validationCodeLabel == "Check2NumericReadings")
            {
            ...
            if (dataOK)
            {
                ...
                else if (processCodeLabel == "WCAverage")
                {
                    ///waist circumference
                    nextCode = ToCode;
                ...
                else if (processCodeLabel == "HCAverage")
                {
                    ///hip circumference
                    nextCode = ToCode;
