    ...
    class QuestionTextDuplicate : Question
    {
        ...
        public override string processUserData()
        {
            ...
            else
            {
                ...
                else if (validationCodeLabel == "TestSBPhigherThanDBP")
                {
            ...
            if (dataOK)
            {
                ...
                if (processCodeLabel == "CalcAverageSecondAndThirdReadingsSYST")
                {
                ...
                else if (processCodeLabel == "CalcAverageSyst")
                {
                ...
                else if (processCodeLabel == "CalcAverageDiast")
                {
                ...
                else if (processCodeLabel == "CalcAverageSecondAndThirdReadingsDIAST")
                {
                ...
                else if (processCodeLabel == "CalcAverageSecondAndThirdReadingsPLS")
                {
                ...
                else if (processCodeLabel == "TakeWCaverageFirst2")
                {
                    //waist circumference
                ...
                else if (processCodeLabel == "TakeWCaverageAll3")
                {
                ...
                else if (processCodeLabel == "TakeHIPSaverageFirst2")
                {
                    //hips circumference
                ...
                else if (processCodeLabel == "TakeHIPSaverageAll3")
                {
